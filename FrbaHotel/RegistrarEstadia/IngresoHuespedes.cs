        ...
        private void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (e.ColumnIndex.Equals(0))
            {
                ...
                else
                {
                    ...
                    string create_estadia = "insert into WHERE_EN_EL_DELETE_FROM.estadias(reserva_id, ingreso_empleado_id, ingreso_fecha, egreso_fecha) VALUES("+ codigo_reserva + ",1, GETDATE(), GETDATE())";
